package com.palm.common.opengl;

import android.opengl.GLES20;

import com.palm.common.opengl.OpenglHelper.RGBRendThread;
...
public class RGB24GLProgram {
  ...
  public void buildProgram() {
    mGLProgram = createProgram(VERTEX_SHADER1, FRAGMENT_SHADER_RGB);
    mYtid = -1;
    mUtid = -1;
    mVtid = -1;
    /*
  ...
  public void buildTexturesSingle(Buffer ir, int width, int height) {
    boolean videoSizeChanged = (width != mVideoWidth || height != mVideoHeight);
    if (videoSizeChanged) {
      mVideoWidth = width;
      mVideoHeight = height;
